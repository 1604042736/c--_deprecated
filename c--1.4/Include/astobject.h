...
{
	ASTOBJECT_HEAD;
	struct IntObject* value;
};

struct Object* NumASTObject_New();
struct Object* NumASTObject_NewWithParser(struct Parser*);

static struct ObjectAttribute NumASTObjectAttribute = {
	(char*)"Num",
	NULL,	//obj_add
	NULL,	//obj_and
	NULL,	//obj_bool
